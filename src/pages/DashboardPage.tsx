    ...
    <div className="container py-4">
          ...
          <>
            <div className="row g-3">
              ...
              {alunos?.results?.map((aluno: Aluno) => (
                <div key={aluno.id} className="col-12 col-md-4">
      ...
      <section className="mb-5">
        ...
        {loadingProfs ? (
          ...
          <p className="text-center mt-4 text-danger">Erro ao carregar os professores.</p>
        ) : (
          <>
            <div className="row g-3">
              ...
              {professores?.results?.map((prof: Professor) => (
                <div key={prof.id} className="col-12 col-md-4">
                  <div className="card h-100 shadow-sm">
                    <div className="card-body d-flex flex-column">
      ...
      <section className="mb-5">
        ...
        {loadingMats ? (
          ...
          <p className="text-center mt-4 text-danger">Erro ao carregar as matérias.</p>
        ) : (
          <>
            <div className="row g-3">
              ...
              {materias?.results?.map((mat: Materia) => (
                <div key={mat.id} className="col-12 col-md-4">
                  <div className="card h-100 shadow-sm">
                    <div className="card-body d-flex flex-column">
      ...
      <section className="mb-5">
        ...
        {loadingTurmas ? (
          ...
          <p className="text-center mt-4 text-danger">Erro ao carregar as turmas.</p>
        ) : (
          <>
            <div className="row g-3">
              {turmas?.results?.length === 0 && (
                <p className="col-12 text-center text-muted">Nenhuma turma cadastrada.</p>
              )}
              {turmas?.results?.map((turma: Turma) => (
                <div key={turma.id} className="col-12 col-md-4">
                  <div className="card h-100 shadow-sm">
                    <div className="card-body d-flex flex-column">
      ...
      <section className="mb-5">
        ...
        {loadingTM ? (
          ...
          <p className="text-center mt-4 text-danger">Erro ao carregar os vínculos.</p>
        ) : (
          <>
            <div className="row g-3">
              {turmaMaterias?.results?.length === 0 && (
                <p className="col-12 text-center text-muted">Nenhum vínculo cadastrado.</p>
              )}
              {turmaMaterias?.results?.map((tm: TurmaMateria) => (
                <div key={tm.id} className="col-12 col-md-4">
                  <div className="card h-100 shadow-sm">
                    <div className="card-body d-flex flex-column">
      ...
      <section className="mb-5">
        ...
        {loadingAvals ? (
          ...
          <p className="text-center mt-4 text-danger">Erro ao carregar as avaliações.</p>
        ) : (
          <>
            <div className="row g-3">
              ...
              {avaliacoes?.results?.map((aval: Avaliacao) => (
                <div key={aval.id} className="col-12 col-md-4">
                  <div className="card h-100 shadow-sm">
                    <div className="card-body d-flex flex-column">
